...
config.Gamma = 0.00006; % 0.0005 for egret
...
config.rescale_sz = 128; % the smallest dimension is 96
...
if ~exist('/media/vclagpu/Data1/JerryXu/nfa', 'dir'), mkdir('/media/vclagpu/Data1/JerryXu/nfa');end
...
if ~exist(config.Synfolder, 'dir'), mkdir(config.Synfolder);end
